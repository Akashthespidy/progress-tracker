...
import { Target, Clock, MoreHorizontal, Trash2, Brain, ArrowRight } from "lucide-react";
            ...
            {showMenu && (
              <>
                ...
                <div className="absolute right-0 top-8 z-20 w-44 py-1.5 bg-[var(--bg-elevated)] border border-[var(--border-secondary)] rounded-xl shadow-xl animate-scale-in">
                  <Link
                    href={`/dashboard/goals/${goal.id}`}
                    className="w-full px-3 py-2 text-left text-xs hover:bg-[var(--bg-hover)] text-indigo-400 flex items-center gap-2"
                  >
